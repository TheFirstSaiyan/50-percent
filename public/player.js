...
//sss	scoreText= select("#score");
//sss	scoreText.size(200);
	//sssscoreText.position(170,-14);
//sss	scoreText.html("SCORE : 0");
	...
	//receive location data from any other client connected to the server

	clientSocket.on('positionData', replicate);
	//sssclientSocket.on("startTimer", startTimer);
	//sssclientSocket.on("clearTimer", clearTimer);
//sss	clientSocket.on("increaseScore",increaseScore);
//sss	clientSocket.on("rankInfo",displayRank);
